...
export default class DamageRoll extends Roll {
  ...
  configureDamage() {
    ...
    if ( this.options.powerfulCritical && (flatBonus > 0) ) {
      ...
      this.terms.push(new NumericTerm({number: flatBonus}, {flavor: game.i18n.localize("WWNPRETTY.PowerfulCritical")}));
    }
  ...
  toMessage(messageData={}, options={}) {
    ...
    if ( this.isCritical ) {
      const label = game.i18n.localize("WWNPRETTY.CriticalHit");
      ...
      new Dialog({
        ...
        buttons: {
          critical: {
            ...
            label: game.i18n.localize("WWNPRETTY.CriticalHit"),
            callback: html => resolve(this._onDialogSubmit(html, true))
          },
          normal: {
            label: game.i18n.localize(allowCritical ? "WWNPRETTY.Normal" : "WWNPRETTY.Roll"),
