...
export default class ActiveEffect5e extends ActiveEffect {
  ...
  determineSuppression() {
    ...
    this.isSuppressed = itemData.carried === false || (itemData.attunement === CONFIG.WWNPRETTY.attunementTypes.REQUIRED);
  }
    ...
    switch ( a.dataset.action ) {
      case "create":
        return owner.createEmbeddedDocuments("ActiveEffect", [{
          label: game.i18n.localize("WWNPRETTY.EffectNew"),
  ...
  static prepareActiveEffectCategories(effects) {
    ...
    const categories = {
      temporary: {
        type: "temporary",
        label: game.i18n.localize("WWNPRETTY.EffectTemporary"),
        effects: []
      },
      passive: {
        type: "passive",
        label: game.i18n.localize("WWNPRETTY.EffectPassive"),
        effects: []
      },
      inactive: {
        type: "inactive",
        label: game.i18n.localize("WWNPRETTY.EffectInactive"),
        effects: []
      },
      suppressed: {
        type: "suppressed",
        label: game.i18n.localize("WWNPRETTY.EffectUnavailable"),
        effects: [],
        info: [game.i18n.localize("WWNPRETTY.EffectUnavailableInfo")]
      }
    };
