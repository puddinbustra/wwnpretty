...
export default class ActorHitDiceConfig extends DocumentSheet {
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            classes: ["WWNPRETTY", "hd-config", "dialog"],
            template: "systems/wwnpretty/templates/apps/hit-dice-config.html",
            width: 360,
            height: "auto"
        });
    }
    ...
    /** @override */
    get title() {
        return `${game.i18n.localize("WWNPRETTY.HitDiceConfig")}: ${this.object.name}`;
    }
